    ...
    <div className="py-6">
      <div className="flex max-w-md bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="w-1/3 bg-cover" style={{
          backgroundImage: "url('https://images.pexels.com/photos/4869281/pexels-photo-4869281.jpeg?cs=srgb&dl=pexels-roman-odintsov-4869281.jpg&fm=jpg')"
        }}>
        </div> 
        <div className="w-2/3 p-4">
          <h1 className="text-gray-900 font-bold text-2xl">Coffe</h1>
